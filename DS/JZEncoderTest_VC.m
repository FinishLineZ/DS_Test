...
#import "JZEncoderTest_VC.h"
#import <AVFoundation/AVFoundation.h>
#import "JZAACEncoder.h"
#import "JZH264Encoder.h"
//#import "avformat.h"

#define CAPTURE_FRAMES_PER_SECOND       20
#define SAMPLE_RATE                     44100
#define VideoWidth                      IPHONE_WIDTH
#define VideoHeight                     IPHONE_HEIGHT

@interface JZEncoderTest_VC ()<AVCaptureVideoDataOutputSampleBufferDelegate,AVCaptureAudioDataOutputSampleBufferDelegate,JZH264EncoderDelegate>
...
@property (nonatomic, strong) JZH264Encoder              *h264Encoder;
@property (nonatomic, strong) JZAACEncoder               *aacEncoder;
...
@implementation JZEncoderTest_VC
...
- (void)setupAudioCapture {
    ...
    self.aacEncoder = [JZAACEncoder new];
...
- (void)setupVideoCapture {
    ...
    self.h264Encoder = [JZH264Encoder new];
